...
*/
    ...
    I.load = function(dep) {
        ...
        script.src = baseDir + depName + (fname[fname.length-1] === "js" ? "" : ".js");
    ...
    I.define = function() {
        ...
        if((len === 2 || len === 3) && arguments[0] instanceof String) {
            dep.name = arguments[0];
        }
        if(len === 2 && arguments[0] instanceof Array) {
            dep.deps = arguments[0];
        } else if(len === 3 && arguments[1] instanceof Array) {
            dep.deps = arguments[1];
        }
        if(dep.name !== null) {
    ...
    I.onLoad = function(dep) {
        ...
        if(typeof lastDefined !== "undefined" && lastDefined !== null) {
            if(lastDefined.deps.length === 0) {
                dep.definition = (typeof lastDefined.definition === "function") ? lastDefined.definition() : lastDefined.definition;
                I.complete(dep);
            } else {
